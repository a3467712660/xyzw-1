      ...
      <div class="function-section">
        <div class="function-left">
          <div class="export-options">
            ...
            <div v-if="exportmethod.includes('1')" class="batch-size-input batch-size-inline">
              <span class="batch-size-label">每分钟查询:</span>
              <NInputNumber
                class="input-w-150"
                size="small"
      ...
      <div v-if="playerInfo" class="player-info-content">
        ...
        <div class="player-heroes">
          ...
          <div
            ...
            class="debug-info debug-info-bottom"
          >
          ...
          <div v-else class="empty-heroes">
            ...
            <div
              v-if="playerInfo.heroList"
              class="debug-info debug-info-top"
            >
              武将列表为空
            </div>
            <div v-else class="debug-info debug-info-top">
              武将列表未定义
            </div>
          </div>
        </div>
